...
void main() {
  ...
  late MovieRemoteDataSourceImpl movieDataSource;
  late MockHttpClient mockHttpClient;

  setUp(() {
    mockHttpClient = MockHttpClient();
    movieDataSource = MovieRemoteDataSourceImpl(client: mockHttpClient);
  });
  ...
  group('get Now Playing Movies', () {
    ...
    test('should return list of Movie Model when the response code is 200',
      ...
      // act
      final result = await movieDataSource.getNowPlayingMovies();
      // assert
    ...
    test(
      ...
      // act
      final call = movieDataSource.getNowPlayingMovies();
      // assert
  ...
  group('get Popular Movies', () {
    ...
    test(
      ...
      when(mockHttpClient.get(Uri.parse('$BASE_URL/movie/popular?$API_KEY')))
          .thenAnswer((_) async => http.Response('Not Found', 404));
      // act
      final call = movieDataSource.getPopularMovies();
      // assert
      expect(() => call, throwsA(isA<ServerException>()));
    });
  });
  ...
  group('get Top Rated Movies', () {
    ...
    test('should throw ServerException when response code is other than 200',
      ...
      when(mockHttpClient.get(Uri.parse('$BASE_URL/movie/top_rated?$API_KEY')))
          .thenAnswer((_) async => http.Response('Not Found', 404));
      // act
      final call = movieDataSource.getTopRatedMovies();
      // assert
      expect(() => call, throwsA(isA<ServerException>()));
    });
  });
  ...
  group('get movie detail', () {
    ...
    test('should return movie detail when the response code is 200', () async {
      ...
      // act
      final result = await movieDataSource.getMovieDetail(tId);
      // assert
    ...
    test('should throw Server Exception when the response code is 404 or other',
      ...
      when(mockHttpClient.get(Uri.parse('$BASE_URL/movie/$tId?$API_KEY')))
          .thenAnswer((_) async => http.Response('Not Found', 404));
      // act
      final call = movieDataSource.getMovieDetail(tId);
      // assert
      expect(() => call, throwsA(isA<ServerException>()));
    });
  });
  ...
  group('get movie recommendations', () {
    ...
    test('should return list of Movie Model when the response code is 200',
      ...
      // act
      final result = await movieDataSource.getMovieRecommendations(tId);
      // assert
      expect(result, equals(tMovieList));
    });
    ...
    test('should throw Server Exception when the response code is 404 or other',
      ...
      when(mockHttpClient
          ...
          .thenAnswer((_) async => http.Response('Not Found', 404));
      // act
      final call = movieDataSource.getMovieRecommendations(tId);
      // assert
      expect(() => call, throwsA(isA<ServerException>()));
    });
  });
  ...
  group('search movies', () {
    ...
    test('should return list of movies when response code is 200', () async {
      ...
      // act
      final result = await movieDataSource.searchMovies(tQuery);
      // assert
    ...
    test('should throw ServerException when response code is other than 200',
      ...
      when(mockHttpClient
          ...
          .thenAnswer((_) async => http.Response('Not Found', 404));
      // act
      final call = movieDataSource.searchMovies(tQuery);
      // assert
      expect(() => call, throwsA(isA<ServerException>()));
    });
  });
